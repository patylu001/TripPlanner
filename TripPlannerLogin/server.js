...
const WebAppStrategy = require("./node_modules/ibmcloud-appid/lib/appid-sdk").WebAppStrategy;
...
let webAppStrategy = new WebAppStrategy({
	...
	clientId: "c4101e7a-8da3-4ce7-b043-f926b4865937",
	secret: "Njk3Njk1NjItMzZhYS00MzVlLTk1MmYtNjNiZDVkNmQ0ZDIw",
...
function isLoggedIn(req) {
	//console.log("ACCESS TOKEN ["+req.session[WebAppStrategy.AUTH_CONTEXT].accessToken+"]");
	//console.log("ID TOKEN ["+req.session[WebAppStrategy.AUTH_CONTEXT].identityToken+"]");
